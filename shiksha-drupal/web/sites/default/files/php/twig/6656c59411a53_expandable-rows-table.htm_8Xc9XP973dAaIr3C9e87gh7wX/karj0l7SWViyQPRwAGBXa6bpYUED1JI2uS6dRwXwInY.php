...
class __TwigTemplate_2568f0fba727513155a85977d5e3748c extends Template
{
    private $source;
    private $macros = [];
...
$context["loop"], "index", [], "any", false, false, true, 93) == (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["row"], "cells", [], "any", false, false, true, 93)) - 3))) {
        ...
        <tr ";
                // line 103
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["row"], "attributes", [], "any", false, false, true, 103), "addClass", [($context["row_classes"] ?? null)], "method", false, false, true, 103), "addClass", [($context["row_classes"] ?? null)], "method", false, false, true, 103), "addClass", ["advanced-opts"], "method", false, false, true, 103), 103, $this->source), "html", null, true);
                echo " id=\"adv-opt-";
...
", "modules/contrib/jsonapi_extras/templates/expandable-rows-table.html.twig", "/var/www/html/web/modules/contrib/jsonapi_extras/templates/expandable-rows-table.html.twig");
    }
